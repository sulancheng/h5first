/**
 * Created by sucheng on 2017/8/8.
 */
...
var Zepto = function () {
    ...
    var a, b, c, d, e = [], f = e.slice, g = window.document, h = {}, i = {}, j = g.defaultView.getComputedStyle,
        ...
        l = /^\s*<(\w+|!)[^>]*>/, m = [1, 3, 8, 9, 11], n = ["after", "prepend", "before", "append"],
        ...
        r = /complete|loaded|interactive/, s = /^\.([\w-]+)$/, t = /^#([\w-]+)$/, u = /^[\w-]+$/, v = {}.toString,
...
window.Zepto = Zepto, "$" in window || (window.$ = Zepto), function (a) {
    ...
    var jsonpID = 0, isObject = $.isObject, document = window.document, key, name,
